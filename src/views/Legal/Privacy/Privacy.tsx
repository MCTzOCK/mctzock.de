    ...
    <div className={"sub-page"}>
      ...
      <div className={"sub-page-content"}>
        <p>
          ...
          Geschäftsleitung der mctzock.de. Eine Nutzung der Internetseiten der
          mctzock.de ist grundsätzlich ohne jede Angabe personenbezogener Daten
        ...
        <p>
          ...
          und in Übereinstimmung mit den für die mctzock.de geltenden
        ...
        <p>
          Die mctzock.de hat als für die Verarbeitung Verantwortlicher
        ...
        <p>
          ...
          mctzock.de keine Rückschlüsse auf die betroffene Person. Diese
          ...
          anonym erhobenen Daten und Informationen werden durch die mctzock.de
        ...
        <ul style={{ listStyle: "none" }}>
          ...
          <li>
            ...
            <p>
              ...
              bei der mctzock.de gespeichert sind, veranlassen möchte, kann sie
              sich hierzu jederzeit an einen Mitarbeiter des für die
              Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der
              mctzock.de wird veranlassen, dass dem Löschverlangen unverzüglich
              nachgekommen wird.
            </p>
            <p>
              Wurden die personenbezogenen Daten von der mctzock.de öffentlich
              gemacht und ist unser Unternehmen als Verantwortlicher gemäß Art.
              17 Abs. 1 DS-GVO zur Löschung der personenbezogenen Daten
              verpflichtet, so trifft die mctzock.de unter Berücksichtigung der
              ...
              mctzock.de wird im Einzelfall das Notwendige veranlassen.
            </p>
          </li>
          <li>
            ...
            <p>
              ...
              Daten, die bei der mctzock.de gespeichert sind, verlangen möchte,
              kann sie sich hierzu jederzeit an einen Mitarbeiter des für die
              Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der
              mctzock.de wird die Einschränkung der Verarbeitung veranlassen.
            </p>
          </li>
          <li>
          ...
          <li>
            ...
            <p>
              Die mctzock.de verarbeitet die personenbezogenen Daten im Falle
            ...
            <p>
              Verarbeitet die mctzock.de personenbezogene Daten, um
              ...
              Person gegenüber der mctzock.de der Verarbeitung für Zwecke der
              Direktwerbung, so wird die mctzock.de die personenbezogenen Daten
            ...
            <p>
              ...
              Verarbeitung personenbezogener Daten, die bei der mctzock.de zu
            ...
            <p>
              ...
              Person direkt an jeden Mitarbeiter der mctzock.de oder einen
          ...
          <li>
            ...
            <p>
              ...
              mctzock.de angemessene Maßnahmen, um die Rechte und Freiheiten
